...
export function parsePortalServerEnv(source: NodeJS.ProcessEnv = process.env) {
  ...
  return {
    ...
    staffLaunchUrlTemplate: source.HOS_STAFF_LAUNCH_URL ?? "https://hospitality.getlifeos.app/admin?tenant={subdomain}",
    guestLaunchUrlTemplate: source.HOS_GUEST_LAUNCH_URL ?? "https://hospitality.getlifeos.app/?tenant={subdomain}",
