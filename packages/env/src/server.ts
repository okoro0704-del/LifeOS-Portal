...
export function parsePortalServerEnv(source: NodeJS.ProcessEnv = process.env) {
  ...
  return {
    ...
    staffLaunchUrlTemplate: source.HOS_STAFF_LAUNCH_URL ?? "https://{subdomain}.lifeos.app/admin",
    guestLaunchUrlTemplate: source.HOS_GUEST_LAUNCH_URL ?? "https://{subdomain}.lifeos.app/",
