...
export function parsePortalServerEnv(source: NodeJS.ProcessEnv = process.env) {
  ...
  return {
    ...
    storefrontLaunchUrlTemplate: source.ECO_STOREFRONT_LAUNCH_URL ?? "https://{subdomain}.getlifeos.app",
    adminLaunchUrlTemplate: source.ECO_ADMIN_LAUNCH_URL ?? "https://{subdomain}.getlifeos.app/admin",
    ...
    netlifyAuthToken: source.NETLIFY_AUTH_TOKEN ?? "",
